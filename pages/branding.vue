        ...
        <div class="row my-4">
              ...
              <div class="card rounded-3 overflow-hidden">
                <div class="card-body bg-dark">
                  <a href="/images/logos/logo_dimatis_3000_white.png" download="dimatis-logo-white.png">
                    <div class="position-absolute top-0 end-0 m-1 px-1 bg-white rounded small text-dark">3000x3000px</div>
              ...
              <div class="card rounded-3 overflow-hidden">
                <div class="card-body">
                  <a href="/images/logos/logo_dimatis_3000.png" download="dimatis-logo-black.png">
                    <div class="position-absolute top-0 end-0 m-1 px-1 bg-dark rounded small">3000x3000px</div>
          ...
          <div class="col-12 text-start mx-auto">
            <div class="d-flex justify-content-center gap-4">
              <div class="card rounded-3 overflow-hidden">
                <div class="card-body bg-dark">
                  <a href="/images/logos/text_logo_dimatis_white.png" download="dimatis-logo-white.png">
                    <div class="position-absolute top-0 end-0 m-1 px-1 bg-white rounded small text-dark">5000x987px</div>
              ...
              <div class="card rounded-3 overflow-hidden">
                <div class="card-body">
                  <a href="/images/logos/text_logo_dimatis.png" download="dimatis-logo-black.png">
                    <div class="position-absolute top-0 end-0 m-1 px-1 bg-dark rounded small">5000x987px</div>
