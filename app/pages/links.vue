      ...
      <div class="card rounded-4 col-lg-7 mx-auto overflow-hidden">
        ...
        <div class="card-body px-lg-5 bg-body-secondary">
          ...
          <div class="position-relative neon scale-on-hover normal">
            <a ref="releasepop" :href="`${SITE.fanlinksUrl}/${page.cover ? page.cover : page.id}`" class="bg-body-tertiary d-flex align-items-center rounded-4 overflow-hidden mb-2 border text-decoration-none position-relative z-1" data-bs-toggle="popover">
