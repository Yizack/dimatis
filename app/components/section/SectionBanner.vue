...
<template>
  <section id="banner" style="background-image: url('/images/backgrounds/profile.webp');" class="banner position-relative bg-body-secondary">
          ...
          <div class="d-flex">
            ...
            <div class="position-relative align-self-center">
              ...
              <span class="bg-white rounded text-dark small py-1 px-2">
                <span v-if="followers && followers.spotify">{{ followers.spotify }} followers</span>
